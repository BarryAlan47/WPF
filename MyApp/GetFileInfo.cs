...
namespace MyApp
{
    public class GetFileInfo
    {
        ...
        public Hashtable GetFileFullInfo(string filePath)
        {
            ...
            {
                fileType = "视频文件";
                bgColor = (System.Windows.Media.Brush)converter.ConvertFromString("#7E5134");
            }
            else if (fileExtension == ".jpg" || fileExtension == ".png")
            {
                fileType = "图片文件";
                bgColor = (System.Windows.Media.Brush)converter.ConvertFromString("#4A1561");
            }
            else
            {
                fileType = "未知类型文件";
        ...
        public List<string> GetFilePath()
        {
            ...
            {
                Multiselect = true,
                Filter = "Office Files|*.doc;*.docx;*.xls;*.xlsx;*.pdf;*.mp4;*.jpg;*.png" //删选、设定文件显示类型
            };
